...
using Application.Specifications.Abstractions;
...
{
    protected readonly ClubKeyDbContext _context;

    public RepositoryBase(ClubKeyDbContext context)
    {
        _context = context;
    }
    ...
    public async Task<bool> UpdateRangeAsync(IEnumerable<T> entities)
    {
        ...
        _context.Set<T>().AttachRange(enumerable);
